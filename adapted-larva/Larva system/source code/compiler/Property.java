...
public class Property extends Compiler {
	...
	public void appendJava(StringBuilder sb, Global g, Global root)throws ParseException
	{
		...
		//////////Note: now code does not generate numbers for events
		//////////
		sb.append("\r\n\r\npublic void _performLogic_"+name+"(String _infoSISM) {");
		//sb.append("\r\n\r\npublic void _performLogic_"+name+"(String _infoSM) {");//DYF/05/12/2013
		
		transitions.appendJava(sb, this, g, root);
		
		sb.append("\r\n}");
		
		sb.append("\r\n\r\npublic void _goto_"+name+"(String _infoSISM){");
		//sb.append("\r\n\r\npublic void _goto_"+name+"(String _infoSM){");//DYF/05/12/2013
		if (Compiler.verbose){
			sb.append("\r\n_monitor"+root.id+".pw.println(\"[" + name + "]MOVED ON METHODCALL: \"+ _infoSISM +\" TO STATE::> \" + _string_"+name+"(_state_id_"+name+", 1));");
			//sb.append("\r\n_monitor"+root.id+".pw.println(\"[" + name + "]MOVED ON METHODCALL: \"+ _infoSM +\" TO STATE::> \" + _string_"+name+"(_state_id_"+name+", 1));");
			//DYF/05/12/2013
			sb.append("\r\n_monitor"+root.id+".pw.flush();");
		}
		sb.append("\r\n}");
