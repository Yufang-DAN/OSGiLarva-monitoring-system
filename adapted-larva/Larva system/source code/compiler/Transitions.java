...
public class Transitions extends Compiler{
	...
	{
		if (Compiler.verbose){
			sb.append("\r\n\r\n_monitor"+root.id+".pw.println(\"Event name = "+"\" + " );
			//sb.append("\r\n\r\n_monitor"+root.id+".pw.println(\"infoSM = "+"\" + " );//DYF/05/12/2013
			sb.append("_infoSISM);");
			//sb.append("_infoSM);");//DYF/05/12/2013
			sb.append("\r\n\r\n_monitor"+root.id+".pw.println(\"[" + l.name + "]AUTOMATON::> "+l.name+"(\"+");
